...
import rhkafka.utils.GetItems;
import rhkafka.utils.GetNames;
                ...
                public void changed(Item item, ItemState itemState) {
                    ...
                    try {
                        ...
                        if(clph.get(item.getId().substring(3)) == "clph"){
                            producer.send(new ProducerRecord<String, String>("clph",sdf.format(itemState.getTimestamp().getTime()) + "---" + item.getId() + "---" + value  + "---" + itemState.getQuality()  + "---" + sdf.format(new Date())));
//                            bw.write(sdf.format(itemState.getTimestamp().getTime()) + "---" + item.getId() + "---" + value  + "---" + itemState.getQuality()  + "---" + sdf.format(new Date()) + "\r\n");
                        }
                        producer.send(new ProducerRecord<String, String>("test",sdf.format(itemState.getTimestamp().getTime()) + "---" + item.getId() + "---" + value  + "---" + itemState.getQuality()  + "---" + sdf.format(new Date())));
