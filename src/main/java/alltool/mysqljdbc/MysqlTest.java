...
public class MysqlTest {
    ...
    @Test       //查询数据：query->ArrayListHandler(不可取不直观)
    ...
    @Test       //查询：query -> BeanListHandler(返回bean对象数组)
    ...
    @Test       //查询：query -> BeanHandler(返回bean单个对象)
    ...
    @Test       //查询值返回：query -> ScalarHandler（单个值）
    ...
    @Test           //查询多个值返回给数组：query -> ArrayHandler
...
//		查询全公司的最高成绩，最低成绩，平均成绩，总成绩
    ...
    @Test       //查询之返回到map直观显示：query -> MapHandler
...
//			System.out.println(name + ":" + value);
    ...
    @Test       //分组查询返回list<Map>：query -> MapListHandler
